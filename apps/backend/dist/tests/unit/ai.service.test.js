...
describe('AIService', () => {
    ...
    describe('generateResponse', () => {
        it('should throw error when Groq unavailable', async () => {
            ...
            const originalApiKey = env_1.CONFIG.GROQ_API_KEY;
            Object.defineProperty(env_1.CONFIG, 'GROQ_API_KEY', { value: undefined, writable: true, configurable: true });
            ...
            // Restore the API key
            Object.defineProperty(env_1.CONFIG, 'GROQ_API_KEY', { value: originalApiKey, writable: true, configurable: true });
        });
