...
exports.aiMetadataExtractionService = exports.AIMetadataExtractionService = void 0;
...
class AIMetadataExtractionService {
    constructor() {
        ...
        this.model = env_1.CONFIG.GROQ_MODEL || 'llama-3.3-70b-versatile';
    }
...
${truncatedContent}`;
        try {
            ...
            logger_1.logger.error('AI metadata extraction failed:', error);
            return this.getDefaultMetadata();
        }
    }
    async enrichChunkWithTaxonomy(chunkText, documentTaxonomy) {
...
Return valid JSON:
{
  ...
  "specialty": "${documentTaxonomy.specialty || 'general'}"
        ...
        try {
            ...
            logger_1.logger.error('Chunk taxonomy enrichment failed:', error);
            return {
                disease: [],
                symptoms: [],
                diagnosis: [],
...
exports.AIMetadataExtractionService = AIMetadataExtractionService;
exports.aiMetadataExtractionService = new AIMetadataExtractionService();
//# sourceMappingURL=ai-metadata.service.js.map