...
exports.bm25Service = exports.Bm25Service = void 0;
class Bm25Service {
    constructor() {
        this.k1 = 1.5;
        this.b = 0.75;
        ...
        this.documentTermFrequencies = new Map();
    ...
    async search(query, topK = 20, filter) {
        if (!this.initialized) {
...
exports.Bm25Service = Bm25Service;
exports.bm25Service = new Bm25Service();
//# sourceMappingURL=bm25.service.js.map