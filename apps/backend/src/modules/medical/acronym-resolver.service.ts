...
export class MedicalAcronymResolver {
  private readonly acronyms: Map<string, { expansion: string; category: AcronymResolution['category']; confidence: number }> = new Map([
  ...
  resolveAll(query: string): AcronymExpansion {
    ...
    const resolved: AcronymResolution[] = [];
  ...
  getAcronymsByCategory(category: AcronymResolution['category']): Array<{ acronym: string; expansion: string; confidence: number }> {
    const results: Array<{ acronym: string; expansion: string; confidence: number }> = [];
  ...
  getAllAcronyms(): Array<{ acronym: string; expansion: string; category: string; confidence: number }> {
    const results: Array<{ acronym: string; expansion: string; category: string; confidence: number }> = [];
...
export const medicalAcronymResolver = new MedicalAcronymResolver();
